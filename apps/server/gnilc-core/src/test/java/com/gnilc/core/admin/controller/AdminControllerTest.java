package com.gnilc.core.admin.controller;
...
/** 验证管理员 HTTP 载荷及委托契约，尤其区分可空字段未提交与显式 null。 */
class AdminControllerTest {
    ...
    @Test
    void loginReturnsTheTokenContract() throws Exception {
    ...
    @Test
    void refreshAndLogoutUseTheRefreshTokenHeader() throws Exception {
    ...
    void profileAndAuthorizationReadRoutesPreserveResponseShape() throws Exception {
        ...
        admin.setAvatar("https://images.example.test/images/2026/08/05/alice.png");
