...
/** 沿管理员四类真实查询验证缓存填充，并确认资料更新只失效所属资料缓存。 */
...
class AdminQueryCacheIT {
    ...
    void setUp() {
        ...
        create.setAvatar("images/cached-admin.png");
    ...
    void fourQueriesFillRedisAndProfileUpdateInvalidatesOnlyUserInfo() {
        ...
        assertThat(first.getAvatar()).isEqualTo("images/cached-admin.png");
        ...
        assertThat(admins.getUserInfo().getAvatar()).isEqualTo("images/cached-admin.png");

        AdminDto profile = new AdminDto();
        profile.setNickname("Updated Through Service");
        profile.setAvatar("images/updated-admin.png");
        ...
        assertThat(admins.getUserInfo().getAvatar()).isEqualTo("images/updated-admin.png");
    }
