...
public abstract class AdminApiTestSupport extends ApiTestSupport {
    protected TokenPair loginAsDefaultAdmin() {
        return loginAsAdmin("admin", "123456");
    }

    protected TokenPair loginAsLimitedAdmin() {
        return loginAsAdmin(
                AdminApiTestConfiguration.LIMITED_USERNAME,
                AdminApiTestConfiguration.LIMITED_PASSWORD);
    }

    protected TokenPair loginAsAdmin(String username, String password) {
